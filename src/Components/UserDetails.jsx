...
const UserDetails = () => {
    ...
    return (
        <div className="bg-[#F8F5F0]">
            <div className="container mx-auto px-9 w-full flex flex-col sm:flex-row sm:justify-between items-center py-4">
            ...
            <div className="table-body">
                <div className="overflow-x-auto px-9">
                    <table className="w-[1152px] min-w-full table-auto border-collapse rounded-md bg-white">
